...
\retval ::HI_ERR_AO_CREATE_FAIL	    The device fails to be started. CNcomment:打开设备失败 CNend
...
\retval ::HI_SUCCESS Success CNcomment:成功 CNend
\retval ::HI_FAILURE FAILURE CNcomment:失败 CNend
\retval ::HI_ERR_AO_DEV_NOT_OPEN	    No audio device is started. CNcomment:Audio设备未打开 CNend
\retval ::HI_ERR_AO_INVALID_PARA	    The parameter is invalid. CNcomment:无效的参数 CNend
\retval ::HI_ERR_SND_INVALID_ID	    The parameter enSound is invalid. CNcomment:无效Sound ID CNend
\see \n
N/A
...
\retval ::HI_SUCCESS Success CNcomment:成功 CNend
\retval ::HI_ERR_AO_DEV_NOT_OPEN	        No audio device is started. CNcomment:Audio设备未打开 CNend
\retval ::HI_ERR_AO_INVALID_PORT	        The attach type is invalid. CNcomment:无效绑定类型 CNend
\retval ::HI_ERR_AO_INVALID_PARA	        The parameter is invalid. CNcomment:无效的参数 CNend
\see \n
N/A
*/
...
\retval ::HI_ERR_SND_DEV_NO_INIT    SND uninitialization.CNcomment:SND未初始化 CNend
\retval ::HI_ERR_SND_NULL_PTR          Input pointer is NULL.CNcomment:输入指针为空 CNend
\retval ::HI_ERR_SND_INVALID_PARA   invalid input parameter.CNcomment:输入参数非法 CNend
\retval ::HI_ERR_SND_INVALID_OPT    invalid operation. CNcomment:操作非法 CNend
\see \n
