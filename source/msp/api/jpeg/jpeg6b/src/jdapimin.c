...
jpeg_CreateDecompress (j_decompress_ptr cinfo, int version, size_t structsize)
{
  ...
  /** should initial the  I add some message for hard decode at create decompress
   ...
   ** care: at jinit_memory_mgr,jpeg_mem_init,jpeg_get_small, you should not use
   ** this function.
   **/
   JPEG_Api_InitMessageStruct((j_common_ptr)cinfo);
 /************************************************************************/
