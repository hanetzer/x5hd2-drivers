...
HI_S32 VPSS_DRV_Init(HI_VOID)
{
    ...
    printk("Load hi_vpss.ko success.\t(%s)\n", VERSION_STRING);
#endif
#endif
...
#ifdef MODULE
#ifndef CONFIG_SUPPORT_CA_RELEASE
    printk("Unload hi_vpss.ko success.\t(%s)\n", VERSION_STRING);
#endif
#endif
}
                          ...
                          HI_DRV_VPSS_SOURCE_FUNC_S* pstRegistSrcFunc)
{
    ...
    switch(eSrcMode)
    {
        ...
        case VPSS_SOURCE_MODE_VPSSACTIVE:
            ...
            {
                VPSS_FATAL("\npstRegistSrcFunc is NULL------------->func %s line %d \r\n",
                    __func__, __LINE__);
                return HI_FAILURE;
            }
            else
            {
                ...
                {
                    VPSS_FATAL("\nVPSS_GET_SRCIMAGE || VPSS_REL_SRCIMAGE is NULL------------->func %s line %d \r\n",
                    __func__, __LINE__);
                    return HI_FAILURE;
                }
                else
            ...
            break;
        default:
            VPSS_FATAL("\nSourceMode is invalid------------->func %s line %d \r\n",
                    __func__, __LINE__);
            return HI_FAILURE;
            break;
    }
...
#ifdef MODULE
module_init(VPSS_DRV_Init);
module_exit(VPSS_DRV_Exit);
#endif
