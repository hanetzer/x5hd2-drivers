...
#define ADSP_COM_PHY_REG_BASE  0xf8a20418
#define ADSP_COM_VIR_REG_BASE  0xf8a2041c
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int    Reserved_8            : 12  ; /* [31..20]  */
    } bits;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int    Reserved_13           : 21  ; /* [31..11]  */
    } bits;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int    Reserved_14           : 10  ; /* [31..22]  */
    } bits;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int    Reserved_17           : 8   ; /* [31..24]  */
    } bits;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int    Reserved_18           : 7   ; /* [31..25]  */
    } bits;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int    Reserved_21           : 8   ; /* [31..24]  */
    } bits;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int    Reserved_22           : 27  ; /* [31..5]  */
    } bits;
...
typedef struct
{
	...
	volatile unsigned int         AOE_STATUS1;
...
typedef struct
{
    ...
    volatile unsigned int         AIP_RESERVED0;
...
typedef struct
{
    ...
    volatile unsigned int         ENGINE_RESERVED0;
...
typedef struct
{
    ...
    volatile unsigned int         AOP_RESERVED0;
