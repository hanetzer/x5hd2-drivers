...
typedef HI_S32 (*fp_DRV_Cipher_HdcpParamConfig)(HI_DRV_CIPHER_HDCP_MODE_E enHdcpEnMode, HI_DRV_CIPHER_HDCP_KEY_RAM_MODE_E enRamMode, HI_DRV_CIPHER_HDCP_KEY_TYPE_E enKeyType);
typedef HI_S32 (*fp_DRV_Cipher_ClearHdcpConfig)(HI_VOID);
typedef HI_S32 (*fp_DRV_Cipher_SoftReset)(HI_VOID);
typedef HI_S32 (*fp_DRV_Cipher_LoadHdcpKey)(HI_DRV_CIPHER_FLASH_ENCRYPT_HDCPKEY_S stFlashHdcpKey);
