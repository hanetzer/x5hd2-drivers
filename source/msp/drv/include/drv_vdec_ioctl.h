...
#define UMAPC_VDEC_CHAN_RCVVPSSFRM      _IOWR(HI_ID_VDEC, 0xa0, VDEC_CMD_VPSS_FRAME_S)
...
#define UMAPC_VDEC_CHAN_SETMAINPORT      _IOWR(HI_ID_VDEC, 0xaa, VDEC_CMD_VPSS_FRAME_S)
