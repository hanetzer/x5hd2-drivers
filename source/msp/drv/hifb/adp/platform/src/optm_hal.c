...
HI_VOID OPTM_VDP_GFX_GetLayerAddr(HI_U32 u32Data, HI_U32 *pu32Addr)
{
    ...
    GFX_ADDR.u32 = OPTM_VDP_RegRead((HI_U32)(&(pOptmVdpReg->G0_ADDR.u32)+ u32Data * OPTM_GFX_OFFSET));
...
HI_VOID OPTM_VDP_GFX_SetLayerAddr(HI_U32 u32Data, HI_U32 u32LAddr, HI_U32 u32Stride)
{
    ...
    OPTM_VDP_RegWrite((HI_U32)(&(pOptmVdpReg->G0_ADDR.u32)+ u32Data * OPTM_GFX_OFFSET), G0_ADDR.u32);

    G0_STRIDE.u32 = OPTM_VDP_RegRead((HI_U32)(&(pOptmVdpReg->G0_STRIDE.u32)+ u32Data * OPTM_GFX_OFFSET));
    G0_STRIDE.bits.surface_stride = u32Stride;
    OPTM_VDP_RegWrite((HI_U32)(&(pOptmVdpReg->G0_STRIDE.u32)+ u32Data * OPTM_GFX_OFFSET), G0_STRIDE.u32);
}
...
HI_VOID OPTM_VDP_GFX_GetLayerStride(HI_U32 u32Data, HI_U32 *pu32Stride)
{
    ...
    GFX_STRIDE.u32 = OPTM_VDP_RegRead((HI_U32)(&(pOptmVdpReg->G0_STRIDE.u32)+ u32Data * OPTM_GFX_OFFSET));
...
HI_VOID OPTM_VDP_GFX_SetLutAddr(HI_U32 u32Data, HI_U32 u32LutAddr)
{
    ...
    OPTM_VDP_RegWrite((HI_U32)(&(pOptmVdpReg->G0_PARAADDR.u32)+ u32Data * OPTM_GFX_OFFSET), G0_PARAADDR.u32);
}
...
HI_VOID OPTM_VDP_GFX_SetColorKey(HI_U32 u32Data,HI_U32  bkeyEn,OPTM_VDP_GFX_CKEY_S stKey )
{
    ...
    G0_CKEYMAX.u32 = OPTM_VDP_RegRead((HI_U32)(&(pOptmVdpReg->G0_CKEYMAX.u32)+ u32Data * OPTM_GFX_OFFSET));
    ...
    OPTM_VDP_RegWrite((HI_U32)(&(pOptmVdpReg->G0_CKEYMAX.u32)+ u32Data * OPTM_GFX_OFFSET), G0_CKEYMAX.u32);
	
    G0_CKEYMIN.u32 = OPTM_VDP_RegRead((HI_U32)(&(pOptmVdpReg->G0_CKEYMIN.u32)+ u32Data * OPTM_GFX_OFFSET));
    ...
    OPTM_VDP_RegWrite((HI_U32)(&(pOptmVdpReg->G0_CKEYMIN.u32)+ u32Data * OPTM_GFX_OFFSET), G0_CKEYMIN.u32);

    G0_CBMPARA.u32 = OPTM_VDP_RegRead((HI_U32)(&(pOptmVdpReg->G0_CBMPARA.u32)+ u32Data * OPTM_GFX_OFFSET));
    G0_CBMPARA.bits.key_en = bkeyEn;
    G0_CBMPARA.bits.key_mode = stKey.bKeyMode;            
    OPTM_VDP_RegWrite((HI_U32)(&(pOptmVdpReg->G0_CBMPARA.u32)+ u32Data * OPTM_GFX_OFFSET), G0_CBMPARA.u32); 
...
HI_VOID OPTM_VDP_GFX_SetKeyMask(HI_U32 u32Data, OPTM_VDP_GFX_MASK_S stMsk)
{
    ...
    G0_CMASK.u32 = OPTM_VDP_RegRead((HI_U32)(&(pOptmVdpReg->G0_CMASK.u32)+ u32Data * OPTM_GFX_OFFSET));
    G0_CMASK.bits.kmsk_r = stMsk.u32Mask_r;
    G0_CMASK.bits.kmsk_g = stMsk.u32Mask_g;
    G0_CMASK.bits.kmsk_b = stMsk.u32Mask_b;
    OPTM_VDP_RegWrite((HI_U32)(&(pOptmVdpReg->G0_CMASK.u32)+ u32Data * OPTM_GFX_OFFSET), G0_CMASK.u32);
...
HI_VOID  OPTM_VDP_GFX_SetParaUpd  (HI_U32 u32Data, OPTM_VDP_DISP_COEFMODE_E enMode )
{
    ...
    if (enMode == VDP_DISP_COEFMODE_LUT || enMode == VDP_DISP_COEFMODE_ALL)
    {
        ...
        OPTM_VDP_RegWrite((HI_U32)(&(pOptmVdpReg->G0_PARAUP.u32)+ u32Data * OPTM_GFX_OFFSET), G0_PARAUP.u32);
    }
...
HI_VOID OPTM_VDP_GFX_SetDofEnable(HI_U32 u32Data,HI_U32 bTrue)
{
    ...
    G0_DOFCTRL.u32 = OPTM_VDP_RegRead((HI_U32)(&(pOptmVdpReg->G0_DOFCTRL.u32)+ u32Data * OPTM_GFX_OFFSET));
    G0_DOFCTRL.bits.dof_en = bTrue ;
    OPTM_VDP_RegWrite((HI_U32)(&(pOptmVdpReg->G0_DOFCTRL.u32)+ u32Data * OPTM_GFX_OFFSET), G0_DOFCTRL.u32);
}
...
HI_VOID OPTM_VDP_GFX_SetDofStep ( HI_U32 u32Data, HI_U32 u32eye_sel,HI_U32 u32step)
{
    ...
    if(u32eye_sel== 0)
    {
        ...
        G0_DOFSTEP.u32 = OPTM_VDP_RegRead((HI_U32)(&(pOptmVdpReg->G0_DOFSTEP.u32)+ u32Data * OPTM_GFX_OFFSET));

        G0_DOFSTEP.bits.left_eye = 0 ;
        G0_DOFSTEP.bits.left_step = u32step ;
        OPTM_VDP_RegWrite((HI_U32)(&(pOptmVdpReg->G0_DOFSTEP.u32)+ u32Data * OPTM_GFX_OFFSET), G0_DOFSTEP.u32);
...
HI_VOID OPTM_VDP_GFX_SetDispMode(HI_U32 u32Data, OPTM_VDP_DISP_MODE_E enDispMode)
{
    ...
    OPTM_VDP_RegWrite((HI_U32)(&(pOptmVdpReg->G0_CTRL.u32) + u32Data * OPTM_VID_OFFSET), G0_CTRL.u32); 
...
HI_VOID  OPTM_VDP_GFX_GetLayerInRect(HI_U32 u32Data, OPTM_VDP_DISP_RECT_S *stInRect)
{
    ...
    G0_SFPOS.u32 = OPTM_VDP_RegRead((HI_U32)(&(pOptmVdpReg->G0_SFPOS.u32)+ u32Data * OPTM_GFX_OFFSET));
    stInRect->u32SX = G0_SFPOS.bits.src_xfpos;

    G0_VFPOS.u32 = OPTM_VDP_RegRead((HI_U32)(&(pOptmVdpReg->G0_VFPOS.u32) + u32Data * OPTM_VID_OFFSET));
    stInRect->u32VX = G0_VFPOS.bits.video_xfpos;
    stInRect->u32VY = G0_VFPOS.bits.video_yfpos;
    
    G0_DFPOS.u32 = OPTM_VDP_RegRead((HI_U32)(&(pOptmVdpReg->G0_DFPOS.u32)+ u32Data * OPTM_GFX_OFFSET));
    stInRect->u32DXS = G0_DFPOS.bits.disp_xfpos;
    stInRect->u32DYS = G0_DFPOS.bits.disp_yfpos;
    
    G0_DLPOS.u32 = OPTM_VDP_RegRead((HI_U32)(&(pOptmVdpReg->G0_DLPOS.u32)+ u32Data * OPTM_GFX_OFFSET));
    stInRect->u32DXL = G0_DLPOS.bits.disp_xlpos + 1;
    stInRect->u32DYL = G0_DLPOS.bits.disp_ylpos + 1;

    G0_VLPOS.u32 = OPTM_VDP_RegRead((HI_U32)(&(pOptmVdpReg->G0_VLPOS.u32) + u32Data * OPTM_VID_OFFSET));
    stInRect->u32VXL = G0_VLPOS.bits.video_xlpos + 1;
    stInRect->u32VYL = G0_VLPOS.bits.video_ylpos + 1;

    G0_IRESO.u32 = OPTM_VDP_RegRead((HI_U32)(&(pOptmVdpReg->G0_IRESO.u32)+ u32Data * OPTM_GFX_OFFSET));
...
HI_VOID  OPTM_VDP_GFX_SetLayerReso     (HI_U32 u32Data, OPTM_VDP_DISP_RECT_S  stRect)
{
    ...
    OPTM_VDP_RegWrite((HI_U32)(&(pOptmVdpReg->G0_SFPOS.u32)+ u32Data * OPTM_GFX_OFFSET), G0_SFPOS.u32);

    G0_VFPOS.u32 = OPTM_VDP_RegRead((HI_U32)(&(pOptmVdpReg->G0_VFPOS.u32) + u32Data * OPTM_VID_OFFSET));
    G0_VFPOS.bits.video_xfpos = stRect.u32VX;
    G0_VFPOS.bits.video_yfpos = stRect.u32VY;
    OPTM_VDP_RegWrite((HI_U32)(&(pOptmVdpReg->G0_VFPOS.u32) + u32Data * OPTM_VID_OFFSET), G0_VFPOS.u32); 

    G0_VLPOS.u32 = OPTM_VDP_RegRead((HI_U32)(&(pOptmVdpReg->G0_VLPOS.u32) + u32Data * OPTM_VID_OFFSET));
    G0_VLPOS.bits.video_xlpos = stRect.u32VX + stRect.u32OWth-1;
    G0_VLPOS.bits.video_ylpos = stRect.u32VY + stRect.u32OHgt-1;
    OPTM_VDP_RegWrite((HI_U32)(&(pOptmVdpReg->G0_VLPOS.u32) + u32Data * OPTM_VID_OFFSET), G0_VLPOS.u32); 

    // display position
    G0_DFPOS.u32 = OPTM_VDP_RegRead((HI_U32)(&(pOptmVdpReg->G0_DFPOS.u32)+ u32Data * OPTM_GFX_OFFSET));
    G0_DFPOS.bits.disp_xfpos = stRect.u32DXS;
    G0_DFPOS.bits.disp_yfpos = stRect.u32DYS;
    OPTM_VDP_RegWrite((HI_U32)(&(pOptmVdpReg->G0_DFPOS.u32)+ u32Data * OPTM_GFX_OFFSET), G0_DFPOS.u32);

    G0_DLPOS.u32 = OPTM_VDP_RegRead((HI_U32)(&(pOptmVdpReg->G0_DLPOS.u32)+ u32Data * OPTM_GFX_OFFSET));
    G0_DLPOS.bits.disp_xlpos = stRect.u32DXL-1;
    G0_DLPOS.bits.disp_ylpos = stRect.u32DYL-1;
    OPTM_VDP_RegWrite((HI_U32)(&(pOptmVdpReg->G0_DLPOS.u32)+ u32Data * OPTM_GFX_OFFSET), G0_DLPOS.u32);

    // input width and height
    G0_IRESO.u32 = OPTM_VDP_RegRead((HI_U32)(&(pOptmVdpReg->G0_IRESO.u32)+ u32Data * OPTM_GFX_OFFSET));
    G0_IRESO.bits.iw = stRect.u32IWth - 1;
    G0_IRESO.bits.ih = stRect.u32IHgt - 1;
    OPTM_VDP_RegWrite((HI_U32)(&(pOptmVdpReg->G0_IRESO.u32)+ u32Data * OPTM_GFX_OFFSET), G0_IRESO.u32);
...
HI_VOID  OPTM_VDP_GFX_SetVideoPos     (HI_U32 u32Data, OPTM_VDP_RECT_S  stRect)
{
   ...
   //grap position 
   G0_VFPOS.u32 = OPTM_VDP_RegRead((HI_U32)(&(pOptmVdpReg->G0_VFPOS.u32) + u32Data * OPTM_GFX_OFFSET));
   G0_VFPOS.bits.video_xfpos = stRect.u32X;
   G0_VFPOS.bits.video_yfpos = stRect.u32Y;
   OPTM_VDP_RegWrite((HI_U32)(&(pOptmVdpReg->G0_VFPOS.u32) + u32Data * OPTM_GFX_OFFSET), G0_VFPOS.u32); 
   G0_VLPOS.u32 = OPTM_VDP_RegRead((HI_U32)(&(pOptmVdpReg->G0_VLPOS.u32) + u32Data * OPTM_GFX_OFFSET));
   G0_VLPOS.bits.video_xlpos = stRect.u32X + stRect.u32Wth - 1;
   G0_VLPOS.bits.video_ylpos = stRect.u32Y + stRect.u32Hgt - 1;
   OPTM_VDP_RegWrite((HI_U32)(&(pOptmVdpReg->G0_VLPOS.u32) + u32Data * OPTM_GFX_OFFSET), G0_VLPOS.u32); 
   return ;
}   
...
HI_VOID  OPTM_VDP_GFX_SetRegUp (HI_U32 u32Data)
{
    ...
    OPTM_VDP_RegWrite((HI_U32)(&(pOptmVdpReg->G0_UPD.u32) + u32Data * OPTM_GFX_OFFSET), G0_UPD.u32); 
...
HI_VOID  OPTM_VDP_GFX_SetLayerBkg(HI_U32 u32Data, OPTM_VDP_BKG_S stBkg)
{
    ...
    G0_BK.u32 = OPTM_VDP_RegRead((HI_U32)(&(pOptmVdpReg->G0_BK.u32) + u32Data * OPTM_GFX_OFFSET));
    G0_BK.bits.vbk_y  = stBkg.u32BkgY ;
    G0_BK.bits.vbk_cb = stBkg.u32BkgU;
    G0_BK.bits.vbk_cr = stBkg.u32BkgV;
    OPTM_VDP_RegWrite((HI_U32)(&(pOptmVdpReg->G0_BK.u32) + u32Data * OPTM_GFX_OFFSET), G0_BK.u32); 

    G0_ALPHA.u32 = OPTM_VDP_RegRead((HI_U32)(&(pOptmVdpReg->G0_ALPHA.u32) + u32Data * OPTM_GFX_OFFSET));
    G0_ALPHA.bits.vbk_alpha = stBkg.u32BkgA;
    OPTM_VDP_RegWrite((HI_U32)(&(pOptmVdpReg->G0_ALPHA.u32) + u32Data * OPTM_GFX_OFFSET), G0_ALPHA.u32); 
...
HI_VOID OPTM_VDP_GFX_SetLayerNAddr(HI_U32 u32Data, HI_U32 u32NAddr)
{
    ...
    OPTM_VDP_RegWrite((HI_U32)(&(pOptmVdpReg->G0_NADDR.u32)+ u32Data * OPTM_GFX_OFFSET), G0_NADDR.u32);
...
HI_VOID  OPTM_VDP_GP_SetParaUpd       (HI_U32 u32Data, OPTM_VDP_GP_PARA_E enMode)
{
    ...
    GP0_PARAUP.u32 = OPTM_VDP_RegRead((HI_U32)(&(pOptmVdpReg->GP0_PARAUP.u32) + u32Data * OPTM_GP_OFFSET));
    ...
    OPTM_VDP_RegWrite((HI_U32)(&(pOptmVdpReg->GP0_PARAUP.u32) + u32Data * OPTM_GP_OFFSET), GP0_PARAUP.u32); 
    return ;
}
...
HI_VOID OPTM_VDP_GP_SetIpOrder (HI_U32 u32Data, HI_U32 u32Chn, OPTM_VDP_GP_ORDER_E enIpOrder)
{
    ...
    OPTM_VDP_RegWrite((HI_U32)(&(pOptmVdpReg->GP0_CTRL.u32)+ u32Data * OPTM_GP_OFFSET), GP0_CTRL.u32);
}
...
HI_VOID  OPTM_VDP_GP_GetRect  (HI_U32 u32Data, OPTM_VDP_DISP_RECT_S  *pstRect)
{
    ...
    GP0_IRESO.u32 = OPTM_VDP_RegRead((HI_U32)(&(pOptmVdpReg->GP0_IRESO.u32) + u32Data * OPTM_GP_OFFSET));
    pstRect->u32IWth = GP0_IRESO.bits.iw + 1;
    pstRect->u32IHgt = GP0_IRESO.bits.ih + 1;  

    GP0_ORESO.u32 = OPTM_VDP_RegRead((HI_U32)(&(pOptmVdpReg->GP0_ORESO.u32) + u32Data * OPTM_GP_OFFSET));
...
HI_VOID  OPTM_VDP_GP_SetRect  (HI_U32 u32Data, OPTM_VDP_DISP_RECT_S  stRect)
{
    ...
    OPTM_VDP_RegWrite((HI_U32)(&(pOptmVdpReg->GP0_IRESO.u32) + u32Data * OPTM_GP_OFFSET), GP0_IRESO.u32); 

    GP0_ORESO.u32 = OPTM_VDP_RegRead((HI_U32)(&(pOptmVdpReg->GP0_ORESO.u32) + u32Data * OPTM_GP_OFFSET));
    GP0_ORESO.bits.ow = stRect.u32OWth - 1;
    GP0_ORESO.bits.oh = stRect.u32OHgt - 1;
    OPTM_VDP_RegWrite((HI_U32)(&(pOptmVdpReg->GP0_ORESO.u32) + u32Data * OPTM_GP_OFFSET), GP0_ORESO.u32); 
...
HI_VOID  OPTM_VDP_GP_SetLayerReso (HI_U32 u32Data, OPTM_VDP_DISP_RECT_S  stRect)
{
    ...
    /*video position */ 
    GP0_VFPOS.u32 = OPTM_VDP_RegRead((HI_U32)(&(pOptmVdpReg->GP0_VFPOS.u32) + u32Data * OPTM_GP_OFFSET));
    GP0_VFPOS.bits.video_xfpos = stRect.u32VX;
    GP0_VFPOS.bits.video_yfpos = stRect.u32VY;
    OPTM_VDP_RegWrite((HI_U32)(&(pOptmVdpReg->GP0_VFPOS.u32) + u32Data * OPTM_GP_OFFSET), GP0_VFPOS.u32); 

    GP0_VLPOS.u32 = OPTM_VDP_RegRead((HI_U32)(&(pOptmVdpReg->GP0_VLPOS.u32) + u32Data * OPTM_GP_OFFSET));
    GP0_VLPOS.bits.video_xlpos = stRect.u32VX + stRect.u32OWth - 1;
    GP0_VLPOS.bits.video_ylpos = stRect.u32VY + stRect.u32OHgt - 1;
    OPTM_VDP_RegWrite((HI_U32)(&(pOptmVdpReg->GP0_VLPOS.u32) + u32Data * OPTM_GP_OFFSET), GP0_VLPOS.u32); 

    GP0_DFPOS.u32 = OPTM_VDP_RegRead((HI_U32)(&(pOptmVdpReg->GP0_DFPOS.u32) + u32Data * OPTM_GP_OFFSET));
    GP0_DFPOS.bits.disp_xfpos = stRect.u32DXS;
    GP0_DFPOS.bits.disp_yfpos = stRect.u32DYS;
    OPTM_VDP_RegWrite((HI_U32)(&(pOptmVdpReg->GP0_DFPOS.u32) + u32Data * OPTM_GP_OFFSET), GP0_DFPOS.u32); 

    GP0_DLPOS.u32 = OPTM_VDP_RegRead((HI_U32)(&(pOptmVdpReg->GP0_DLPOS.u32) + u32Data * OPTM_GP_OFFSET));
    GP0_DLPOS.bits.disp_xlpos = stRect.u32DXL-1;
    GP0_DLPOS.bits.disp_ylpos = stRect.u32DYL-1;
    OPTM_VDP_RegWrite((HI_U32)(&(pOptmVdpReg->GP0_DLPOS.u32) + u32Data * OPTM_GP_OFFSET), GP0_DLPOS.u32); 
...
HI_VOID  OPTM_VDP_GP_SetLayerGalpha (HI_U32 u32Data, HI_U32 u32Alpha)
{
    ...
    GP0_GALPHA.u32 = OPTM_VDP_RegRead((HI_U32)(&(pOptmVdpReg->GP0_GALPHA.u32) + u32Data * OPTM_GP_OFFSET));
    GP0_GALPHA.bits.galpha = u32Alpha;
    OPTM_VDP_RegWrite((HI_U32)(&(pOptmVdpReg->GP0_GALPHA.u32) + u32Data * OPTM_GP_OFFSET), GP0_GALPHA.u32); 
...
HI_VOID  OPTM_VDP_GP_SetLayerBkg(HI_U32 u32Data, OPTM_VDP_BKG_S stBkg)
{
    ...
    GP0_BK.u32 = OPTM_VDP_RegRead((HI_U32)(&(pOptmVdpReg->GP0_BK.u32) + u32Data * OPTM_GP_OFFSET));
    GP0_BK.bits.vbk_y  = stBkg.u32BkgY;
    GP0_BK.bits.vbk_cb = stBkg.u32BkgU;
    GP0_BK.bits.vbk_cr = stBkg.u32BkgV;
    OPTM_VDP_RegWrite((HI_U32)(&(pOptmVdpReg->GP0_BK.u32) + u32Data * OPTM_GP_OFFSET), GP0_BK.u32); 

    GP0_ALPHA.u32 = OPTM_VDP_RegRead((HI_U32)(&(pOptmVdpReg->GP0_ALPHA.u32) + u32Data * OPTM_GP_OFFSET));
    GP0_ALPHA.bits.vbk_alpha = stBkg.u32BkgA;
    OPTM_VDP_RegWrite((HI_U32)(&(pOptmVdpReg->GP0_ALPHA.u32) + u32Data * OPTM_GP_OFFSET), GP0_ALPHA.u32); 
...
HI_VOID  OPTM_VDP_GP_SetRegUp  (HI_U32 u32Data)
{
    ...
    OPTM_VDP_RegWrite((HI_U32)(&(pOptmVdpReg->GP0_UPD.u32) + u32Data * OPTM_GP_OFFSET), GP0_UPD.u32); 
...
HI_VOID  OPTM_VDP_GP_SetCscDcCoef   (HI_U32 u32Data, OPTM_VDP_CSC_DC_COEF_S pstCscCoef)
{
    ...
    GP0_CSC_IDC.u32 = OPTM_VDP_RegRead((HI_U32)(&(pOptmVdpReg->GP0_CSC_IDC.u32) + u32Data * OPTM_GP_OFFSET));
    GP0_CSC_IDC.bits.cscidc1  = pstCscCoef.csc_in_dc1;
    GP0_CSC_IDC.bits.cscidc0  = pstCscCoef.csc_in_dc0;
    OPTM_VDP_RegWrite((HI_U32)(&(pOptmVdpReg->GP0_CSC_IDC.u32) + u32Data * OPTM_GP_OFFSET), GP0_CSC_IDC.u32); 

    GP0_CSC_ODC.u32 = OPTM_VDP_RegRead((HI_U32)(&(pOptmVdpReg->GP0_CSC_ODC.u32) + u32Data * OPTM_GP_OFFSET));
    GP0_CSC_ODC.bits.cscodc1 = pstCscCoef.csc_out_dc1;
    GP0_CSC_ODC.bits.cscodc0 = pstCscCoef.csc_out_dc0;
    OPTM_VDP_RegWrite((HI_U32)(&(pOptmVdpReg->GP0_CSC_ODC.u32) + u32Data * OPTM_GP_OFFSET), GP0_CSC_ODC.u32); 

    GP0_CSC_IODC.u32 = OPTM_VDP_RegRead((HI_U32)(&(pOptmVdpReg->GP0_CSC_IODC.u32) + u32Data * OPTM_GP_OFFSET));
    GP0_CSC_IODC.bits.cscodc2 = pstCscCoef.csc_out_dc2;
    GP0_CSC_IODC.bits.cscidc2 = pstCscCoef.csc_in_dc2;
    OPTM_VDP_RegWrite((HI_U32)(&(pOptmVdpReg->GP0_CSC_IODC.u32) + u32Data * OPTM_GP_OFFSET), GP0_CSC_IODC.u32); 
    return ;
}
...
{   
    ...
    GP0_CSC_P0.u32 = OPTM_VDP_RegRead((HI_U32)(&(pOptmVdpReg->GP0_CSC_P0.u32)+u32Data*OPTM_GP_OFFSET));
    GP0_CSC_P0.bits.cscp00 = stCscCoef.csc_coef00;
    GP0_CSC_P0.bits.cscp01 = stCscCoef.csc_coef01;
    OPTM_VDP_RegWrite((HI_U32)(&(pOptmVdpReg->GP0_CSC_P0.u32)+u32Data*OPTM_GP_OFFSET), GP0_CSC_P0.u32);

    GP0_CSC_P1.u32 = OPTM_VDP_RegRead((HI_U32)(&(pOptmVdpReg->GP0_CSC_P1.u32)+u32Data*OPTM_GP_OFFSET));
    GP0_CSC_P1.bits.cscp02 = stCscCoef.csc_coef02;
    GP0_CSC_P1.bits.cscp10 = stCscCoef.csc_coef10;
    OPTM_VDP_RegWrite((HI_U32)(&(pOptmVdpReg->GP0_CSC_P1.u32)+u32Data*OPTM_GP_OFFSET), GP0_CSC_P1.u32);

    GP0_CSC_P2.u32 = OPTM_VDP_RegRead((HI_U32)(&(pOptmVdpReg->GP0_CSC_P2.u32)+u32Data*OPTM_GP_OFFSET));
    GP0_CSC_P2.bits.cscp11 = stCscCoef.csc_coef11;
    GP0_CSC_P2.bits.cscp12 = stCscCoef.csc_coef12;
    OPTM_VDP_RegWrite((HI_U32)(&(pOptmVdpReg->GP0_CSC_P2.u32)+u32Data*OPTM_GP_OFFSET), GP0_CSC_P2.u32);

    GP0_CSC_P3.u32 = OPTM_VDP_RegRead((HI_U32)(&(pOptmVdpReg->GP0_CSC_P3.u32)+u32Data*OPTM_GP_OFFSET));
    GP0_CSC_P3.bits.cscp20 = stCscCoef.csc_coef20;
    GP0_CSC_P3.bits.cscp21 = stCscCoef.csc_coef21;
    OPTM_VDP_RegWrite((HI_U32)(&(pOptmVdpReg->GP0_CSC_P3.u32)+u32Data*OPTM_GP_OFFSET), GP0_CSC_P3.u32);

    GP0_CSC_P4.u32 = OPTM_VDP_RegRead((HI_U32)(&(pOptmVdpReg->GP0_CSC_P4.u32)+u32Data*OPTM_GP_OFFSET));
    GP0_CSC_P4.bits.cscp22 = stCscCoef.csc_coef22;
    OPTM_VDP_RegWrite((HI_U32)(&(pOptmVdpReg->GP0_CSC_P4.u32)+u32Data*OPTM_GP_OFFSET), GP0_CSC_P4.u32);
...
HI_VOID OPTM_VDP_GP_SetZmeEnable  (HI_U32 u32Data, OPTM_VDP_ZME_MODE_E enMode, HI_U32 u32bEnable)
{
    ...
    {
        GP0_ZME_HSP.u32 = OPTM_VDP_RegRead((HI_U32)(&(pOptmVdpReg->GP0_ZME_HSP.u32) + u32Data * OPTM_GP_OFFSET));
        GP0_ZME_HSP.bits.hsc_en = u32bEnable;
        OPTM_VDP_RegWrite((HI_U32)(&(pOptmVdpReg->GP0_ZME_HSP.u32) + u32Data * OPTM_GP_OFFSET), GP0_ZME_HSP.u32); 
    }
    
    if((enMode == VDP_ZME_MODE_VER)||(enMode == VDP_ZME_MODE_ALL))
    {
        GP0_ZME_VSP.u32 = OPTM_VDP_RegRead((HI_U32)(&(pOptmVdpReg->GP0_ZME_VSP.u32) + u32Data * OPTM_GP_OFFSET));
        GP0_ZME_VSP.bits.vsc_en = u32bEnable;
        OPTM_VDP_RegWrite((HI_U32)(&(pOptmVdpReg->GP0_ZME_VSP.u32) + u32Data * OPTM_GP_OFFSET), GP0_ZME_VSP.u32); 
    }
...
HI_VOID OPTM_VDP_GP_SetZmePhase   (HI_U32 u32Data, OPTM_VDP_ZME_MODE_E enMode, HI_S32 s32Phase)
{
    ...
    {
        GP0_ZME_HOFFSET.u32 = OPTM_VDP_RegRead((HI_U32)(&(pOptmVdpReg->GP0_ZME_HOFFSET.u32) + u32Data * OPTM_GP_OFFSET));
        GP0_ZME_HOFFSET.bits.hor_loffset = s32Phase;
        OPTM_VDP_RegWrite((HI_U32)(&(pOptmVdpReg->GP0_ZME_HOFFSET.u32) + u32Data * OPTM_GP_OFFSET), GP0_ZME_HOFFSET.u32); 
    }
    ...
    {
        GP0_ZME_VOFFSET.u32 = OPTM_VDP_RegRead((HI_U32)(&(pOptmVdpReg->GP0_ZME_VOFFSET.u32) + u32Data * OPTM_GP_OFFSET));
        GP0_ZME_VOFFSET.bits.vbtm_offset = s32Phase;
        OPTM_VDP_RegWrite((HI_U32)(&(pOptmVdpReg->GP0_ZME_VOFFSET.u32) + u32Data * OPTM_GP_OFFSET), GP0_ZME_VOFFSET.u32); 
    }
...
HI_VOID OPTM_VDP_GP_SetZmeVerRatio  (HI_U32 u32Data, HI_U32 u32Ratio)
{
    ...
    GP0_ZME_VSR.u32 = OPTM_VDP_RegRead((HI_U32)(&(pOptmVdpReg->GP0_ZME_VSR.u32) + u32Data * OPTM_GP_OFFSET));
    GP0_ZME_VSR.bits.vratio = u32Ratio;
    OPTM_VDP_RegWrite((HI_U32)(&(pOptmVdpReg->GP0_ZME_VSR.u32) + u32Data * OPTM_GP_OFFSET), GP0_ZME_VSR.u32); 
...
HI_VOID OPTM_VDP_GP_SetZmeCoefAddr  (HI_U32 u32Data, HI_U32 u32Mode, HI_U32 u32Addr)
{
    ...
    {
        GP0_HCOEFAD.u32 = OPTM_VDP_RegRead((HI_U32)(&(pOptmVdpReg->GP0_HCOEFAD.u32) + u32Data * OPTM_GP_OFFSET));
        GP0_HCOEFAD.bits.coef_addr = u32Addr;
        OPTM_VDP_RegWrite((HI_U32)(&(pOptmVdpReg->GP0_HCOEFAD.u32) + u32Data * OPTM_GP_OFFSET), GP0_HCOEFAD.u32); 
    }
    else if(u32Mode == VDP_GP_PARA_ZME_VER)
    {
        GP0_VCOEFAD.u32 = OPTM_VDP_RegRead((HI_U32)(&(pOptmVdpReg->GP0_VCOEFAD.u32) + u32Data * OPTM_GP_OFFSET));
        GP0_VCOEFAD.bits.coef_addr = u32Addr;
        OPTM_VDP_RegWrite((HI_U32)(&(pOptmVdpReg->GP0_VCOEFAD.u32) + u32Data * OPTM_GP_OFFSET), GP0_VCOEFAD.u32); 
    }
    else
    {
...
HI_VOID OPTM_VDP_GP_SetParaRd   (HI_U32 u32Data, OPTM_VDP_GP_PARA_E enMode)
{
    ...
    GP0_PARARD.u32 = OPTM_VDP_RegRead((HI_U32)(&(pOptmVdpReg->GP0_PARARD.u32) + u32Data * OPTM_GP_OFFSET));
    ...
    OPTM_VDP_RegWrite((HI_U32)(&(pOptmVdpReg->GP0_PARARD.u32) + u32Data * OPTM_GP_OFFSET), GP0_PARARD.u32); 
    return ;
}
...
HI_VOID  OPTM_VDP_GP_SetTiEnable(HI_U32 u32Data, HI_U32 u32Md,HI_U32 u32Data1)
{
    ...
    {
        GP0_ZME_LTICTRL.u32 = OPTM_VDP_RegRead((HI_U32)(&(pOptmVdpReg->GP0_ZME_LTICTRL.u32)+ u32Data * OPTM_GP_OFFSET));
        GP0_ZME_LTICTRL.bits.lti_en = u32Data1;
        OPTM_VDP_RegWrite((HI_U32)(&(pOptmVdpReg->GP0_ZME_LTICTRL.u32)+ u32Data * OPTM_GP_OFFSET), GP0_ZME_LTICTRL.u32);

    }
    if((u32Md == VDP_TI_MODE_CHM)||(u32Md == VDP_TI_MODE_ALL))
    {
        GP0_ZME_CTICTRL.u32 = OPTM_VDP_RegRead((HI_U32)(&(pOptmVdpReg->GP0_ZME_CTICTRL.u32)+ u32Data * OPTM_GP_OFFSET));
        GP0_ZME_CTICTRL.bits.cti_en = u32Data1;
        OPTM_VDP_RegWrite((HI_U32)(&(pOptmVdpReg->GP0_ZME_CTICTRL.u32)+ u32Data * OPTM_GP_OFFSET), GP0_ZME_CTICTRL.u32);
    }
...
HI_VOID  OPTM_VDP_GP_SetTiHfThd(HI_U32 u32Data, HI_U32 u32Md, HI_U32 * u32TiHfThd)
{
    ...
    if((u32Md == VDP_TI_MODE_LUM)||(u32Md == VDP_TI_MODE_ALL))
    {
        GP0_ZME_LHFREQTHD.u32 = OPTM_VDP_RegRead((HI_U32)(&(pOptmVdpReg->GP0_ZME_LHFREQTHD.u32)+ u32Data * OPTM_GP_OFFSET));
        GP0_ZME_LHFREQTHD.bits.lhfreq_thd0 = u32TiHfThd[0];
        GP0_ZME_LHFREQTHD.bits.lhfreq_thd1 = u32TiHfThd[1];
        OPTM_VDP_RegWrite((HI_U32)(&(pOptmVdpReg->GP0_ZME_LHFREQTHD.u32)+ u32Data * OPTM_GP_OFFSET), GP0_ZME_LHFREQTHD.u32); 
    }
...
HI_VOID  OPTM_VDP_GP_SetTiHpCoef(HI_U32 u32Data, HI_U32 u32Md, HI_S32 * s32Data)
{
    ...
    {
        GP0_ZME_LTICTRL.u32 = OPTM_VDP_RegRead((HI_U32)(&(pOptmVdpReg->GP0_ZME_LTICTRL.u32)+ u32Data * OPTM_GP_OFFSET));
        GP0_ZME_LHPASSCOEF.u32 = OPTM_VDP_RegRead((HI_U32)(&(pOptmVdpReg->GP0_ZME_LHPASSCOEF.u32)+ u32Data * OPTM_GP_OFFSET));
        ...
        OPTM_VDP_RegWrite((HI_U32)(&(pOptmVdpReg->GP0_ZME_LTICTRL.u32)+ u32Data * OPTM_GP_OFFSET), GP0_ZME_LTICTRL.u32); 
        OPTM_VDP_RegWrite((HI_U32)(&(pOptmVdpReg->GP0_ZME_LHPASSCOEF.u32)+ u32Data * OPTM_GP_OFFSET), GP0_ZME_LHPASSCOEF.u32); 
    }

    if((u32Md == VDP_TI_MODE_CHM)||(u32Md == VDP_TI_MODE_ALL))
    {
        GP0_ZME_CTICTRL.u32 = OPTM_VDP_RegRead((HI_U32)(&(pOptmVdpReg->GP0_ZME_CTICTRL.u32)+ u32Data * OPTM_GP_OFFSET));
        GP0_ZME_CHPASSCOEF.u32 = OPTM_VDP_RegRead((HI_U32)(&(pOptmVdpReg->GP0_ZME_CHPASSCOEF.u32)+ u32Data * OPTM_GP_OFFSET));
        ...
        OPTM_VDP_RegWrite((HI_U32)(&(pOptmVdpReg->GP0_ZME_CTICTRL.u32)+ u32Data * OPTM_GP_OFFSET), GP0_ZME_CTICTRL.u32); 
        OPTM_VDP_RegWrite((HI_U32)(&(pOptmVdpReg->GP0_ZME_CHPASSCOEF.u32)+ u32Data * OPTM_GP_OFFSET), GP0_ZME_CHPASSCOEF.u32); 
    }
}
...
HI_VOID  OPTM_VDP_GP_SetTiCoringThd(HI_U32 u32Data, HI_U32 u32Md, HI_U32 u32thd)
{
    ...
    if((u32Md == VDP_TI_MODE_LUM)||(u32Md == VDP_TI_MODE_ALL))
    {
        GP0_ZME_LTITHD.u32 = OPTM_VDP_RegRead((HI_U32)(&(pOptmVdpReg->GP0_ZME_LTITHD.u32)+ u32Data * OPTM_GP_OFFSET));
        GP0_ZME_LTITHD.bits.lcoring_thd = u32thd;
        OPTM_VDP_RegWrite((HI_U32)(&(pOptmVdpReg->GP0_ZME_LTITHD.u32)+ u32Data * OPTM_GP_OFFSET), GP0_ZME_LTITHD.u32); 
    }

    if((u32Md == VDP_TI_MODE_CHM)||(u32Md == VDP_TI_MODE_ALL))
    {
        GP0_ZME_CTITHD.u32 = OPTM_VDP_RegRead((HI_U32)(&(pOptmVdpReg->GP0_ZME_CTITHD.u32)+ u32Data * OPTM_GP_OFFSET));
        GP0_ZME_CTITHD.bits.ccoring_thd = u32thd;
        OPTM_VDP_RegWrite((HI_U32)(&(pOptmVdpReg->GP0_ZME_CTITHD.u32)+ u32Data * OPTM_GP_OFFSET), GP0_ZME_CTITHD.u32); 
    }
...
HI_VOID  OPTM_VDP_GP_SetTiGainCoef(HI_U32 u32Data, HI_U32 u32Md, HI_U32 * u32coef)
{
    ...
    if((u32Md == VDP_TI_MODE_LUM)||(u32Md == VDP_TI_MODE_ALL))
    {
        GP0_ZME_LGAINCOEF.u32 = OPTM_VDP_RegRead((HI_U32)(&(pOptmVdpReg->GP0_ZME_LGAINCOEF.u32)+ u32Data * OPTM_GP_OFFSET));
        ...
        OPTM_VDP_RegWrite((HI_U32)(&(pOptmVdpReg->GP0_ZME_LGAINCOEF.u32)+ u32Data * OPTM_GP_OFFSET), GP0_ZME_LGAINCOEF.u32); 
    }
}
...
HI_VOID OPTM_VDP_WBC_SetZmeCoefAddr(OPTM_VDP_LAYER_WBC_E enLayer, OPTM_VDP_WBC_PARA_E u32Mode, HI_U32 u32Addr)
{
    ...
    else if(enLayer == OPTM_VDP_LAYER_WBC_GP0)
    {
        ...
        if(u32Mode == VDP_WBC_PARA_ZME_HOR)
        {
            GP0_HCOEFAD.u32 = OPTM_VDP_RegRead((HI_U32)(&(pOptmVdpReg->GP0_HCOEFAD.u32) + OPTM_WBC_GP0_SEL * OPTM_GP_OFFSET));
            GP0_HCOEFAD.bits.coef_addr = u32Addr;
            OPTM_VDP_RegWrite((HI_U32)(&(pOptmVdpReg->GP0_HCOEFAD.u32) + OPTM_WBC_GP0_SEL * OPTM_GP_OFFSET), GP0_HCOEFAD.u32); 
        }
        else if(u32Mode == VDP_WBC_PARA_ZME_VER)
        {
            GP0_VCOEFAD.u32 = OPTM_VDP_RegRead((HI_U32)(&(pOptmVdpReg->GP0_VCOEFAD.u32) + OPTM_WBC_GP0_SEL * OPTM_GP_OFFSET));
            GP0_VCOEFAD.bits.coef_addr = u32Addr;
            OPTM_VDP_RegWrite((HI_U32)(&(pOptmVdpReg->GP0_VCOEFAD.u32) + OPTM_WBC_GP0_SEL * OPTM_GP_OFFSET), GP0_VCOEFAD.u32); 
        }
        else
        {
            HI_PRINT("Error,OPTM_VDP_GP_SetZmeCoefAddr() Select a Wrong Mode!\n");
...
HI_VOID  OPTM_VDP_WBC_SetParaUpd (OPTM_VDP_LAYER_WBC_E enLayer, OPTM_VDP_WBC_PARA_E enMode)
{
    ...
    GP0_PARAUP.u32 = OPTM_VDP_RegRead((HI_U32)(&(pOptmVdpReg->GP0_PARAUP.u32) + OPTM_WBC_GP0_SEL * OPTM_GP_OFFSET));
    ...
    else if(enLayer == OPTM_VDP_LAYER_WBC_GP0)
    {
        ...
        OPTM_VDP_RegWrite((HI_U32)(&(pOptmVdpReg->GP0_PARAUP.u32) + OPTM_WBC_GP0_SEL * OPTM_GP_OFFSET), GP0_PARAUP.u32); 
        return ;
    }
}
...
HI_VOID OPTM_VDP_WBC_SetZmeEnable  (OPTM_VDP_LAYER_WBC_E enLayer, OPTM_VDP_ZME_MODE_E enMode, HI_U32 u32bEnable)
{
    ...
    else if(enLayer == OPTM_VDP_LAYER_WBC_GP0)
    {
        if((enMode == VDP_ZME_MODE_HOR)||(enMode == VDP_ZME_MODE_ALL))
        {
            GP0_ZME_HSP.u32 = OPTM_VDP_RegRead((HI_U32)(&(pOptmVdpReg->GP0_ZME_HSP.u32) + OPTM_WBC_GP0_SEL * OPTM_GP_OFFSET));
            GP0_ZME_HSP.bits.hsc_en = u32bEnable;
            OPTM_VDP_RegWrite((HI_U32)(&(pOptmVdpReg->GP0_ZME_HSP.u32) + OPTM_WBC_GP0_SEL * OPTM_GP_OFFSET), GP0_ZME_HSP.u32); 
        }

        if((enMode == VDP_ZME_MODE_VER)||(enMode == VDP_ZME_MODE_ALL))
        {
            GP0_ZME_VSP.u32 = OPTM_VDP_RegRead((HI_U32)(&(pOptmVdpReg->GP0_ZME_VSP.u32) + OPTM_WBC_GP0_SEL * OPTM_GP_OFFSET));
            GP0_ZME_VSP.bits.vsc_en = u32bEnable;
            OPTM_VDP_RegWrite((HI_U32)(&(pOptmVdpReg->GP0_ZME_VSP.u32) + OPTM_WBC_GP0_SEL * OPTM_GP_OFFSET), GP0_ZME_VSP.u32); 
        }
...
HI_VOID  OPTM_VDP_WBC_SetZmeVerRatio(OPTM_VDP_LAYER_WBC_E enLayer, HI_U32 u32Ratio)
{
    ...
    {
        GP0_ZME_VSR.u32 = OPTM_VDP_RegRead((HI_U32)(&(pOptmVdpReg->GP0_ZME_VSR.u32) + OPTM_WBC_GP0_SEL * OPTM_GP_OFFSET));
        GP0_ZME_VSR.bits.vratio = u32Ratio;
        OPTM_VDP_RegWrite((HI_U32)(&(pOptmVdpReg->GP0_ZME_VSR.u32) + OPTM_WBC_GP0_SEL * OPTM_GP_OFFSET), GP0_ZME_VSR.u32); 
    }
    return ;
}
...
HI_VOID  OPTM_VDP_WBC_SetZmePhase    (OPTM_VDP_LAYER_WBC_E enLayer, OPTM_VDP_ZME_MODE_E enMode,HI_S32 s32Phase)
{
    ...
    else if(enLayer == OPTM_VDP_LAYER_WBC_GP0)
    {
        if((enMode == VDP_ZME_MODE_HORL) || (enMode == VDP_ZME_MODE_HOR)||(enMode == VDP_ZME_MODE_ALL))
        {
            GP0_ZME_HOFFSET.u32 = OPTM_VDP_RegRead((HI_U32)(&(pOptmVdpReg->GP0_ZME_HOFFSET.u32) + OPTM_WBC_GP0_SEL * OPTM_GP_OFFSET));
            GP0_ZME_HOFFSET.bits.hor_loffset = s32Phase;
            OPTM_VDP_RegWrite((HI_U32)(&(pOptmVdpReg->GP0_ZME_HOFFSET.u32) + OPTM_WBC_GP0_SEL * OPTM_GP_OFFSET), GP0_ZME_HOFFSET.u32); 
        }
        ...
        if((enMode == VDP_ZME_MODE_VERL)||(enMode == VDP_ZME_MODE_VER)||(enMode == VDP_ZME_MODE_ALL))
        {
            GP0_ZME_VOFFSET.u32 = OPTM_VDP_RegRead((HI_U32)(&(pOptmVdpReg->GP0_ZME_VOFFSET.u32) + OPTM_WBC_GP0_SEL * OPTM_GP_OFFSET));
            GP0_ZME_VOFFSET.bits.vbtm_offset = s32Phase;
            OPTM_VDP_RegWrite((HI_U32)(&(pOptmVdpReg->GP0_ZME_VOFFSET.u32) + OPTM_WBC_GP0_SEL * OPTM_GP_OFFSET), GP0_ZME_VOFFSET.u32); 
        }
...
{   
    ...
    else if(enLayer == OPTM_VDP_LAYER_WBC_GP0)
    {
        ...
        GP0_CSC_IDC.u32 = OPTM_VDP_RegRead((HI_U32)(&(pOptmVdpReg->GP0_CSC_IDC.u32) + OPTM_WBC_GP0_SEL * OPTM_GP_OFFSET));
        GP0_CSC_IDC.bits.csc_en = enCSC;
        OPTM_VDP_RegWrite((HI_U32)(&(pOptmVdpReg->GP0_CSC_IDC.u32) + OPTM_WBC_GP0_SEL * OPTM_GP_OFFSET), GP0_CSC_IDC.u32); 
...
{   
    ...
    else if(enLayer == OPTM_VDP_LAYER_WBC_GP0)
    {
        ...
        GP0_CSC_ODC.u32 = OPTM_VDP_RegRead((HI_U32)(&(pOptmVdpReg->GP0_CSC_ODC.u32) + OPTM_WBC_GP0_SEL * OPTM_GP_OFFSET));
        GP0_CSC_ODC.bits.cscodc1 = stCscCoef.csc_out_dc1;
        GP0_CSC_ODC.bits.cscodc0 = stCscCoef.csc_out_dc0;
        OPTM_VDP_RegWrite((HI_U32)(&(pOptmVdpReg->GP0_CSC_ODC.u32) + OPTM_WBC_GP0_SEL * OPTM_GP_OFFSET), GP0_CSC_ODC.u32); 

        GP0_CSC_IODC.u32 = OPTM_VDP_RegRead((HI_U32)(&(pOptmVdpReg->GP0_CSC_IODC.u32) + OPTM_WBC_GP0_SEL * OPTM_GP_OFFSET));
        GP0_CSC_IODC.bits.cscodc2 = stCscCoef.csc_out_dc2;
        GP0_CSC_IODC.bits.cscidc2 = stCscCoef.csc_in_dc2;
        OPTM_VDP_RegWrite((HI_U32)(&(pOptmVdpReg->GP0_CSC_IODC.u32) + OPTM_WBC_GP0_SEL * OPTM_GP_OFFSET), GP0_CSC_IODC.u32); 
    }
    return ;
}
...
{   
    ...
    {
        GP0_CSC_P0.u32 = OPTM_VDP_RegRead((HI_U32)(&(pOptmVdpReg->GP0_CSC_P0.u32)+OPTM_WBC_GP0_SEL*OPTM_GP_OFFSET));
        GP0_CSC_P0.bits.cscp00 = stCscCoef.csc_coef00;
        GP0_CSC_P0.bits.cscp01 = stCscCoef.csc_coef01;
        OPTM_VDP_RegWrite((HI_U32)(&(pOptmVdpReg->GP0_CSC_P0.u32)+OPTM_WBC_GP0_SEL*OPTM_GP_OFFSET), GP0_CSC_P0.u32);

        GP0_CSC_P1.u32 = OPTM_VDP_RegRead((HI_U32)(&(pOptmVdpReg->GP0_CSC_P1.u32)+OPTM_WBC_GP0_SEL*OPTM_GP_OFFSET));
        GP0_CSC_P1.bits.cscp02 = stCscCoef.csc_coef02;
        GP0_CSC_P1.bits.cscp10 = stCscCoef.csc_coef10;
        OPTM_VDP_RegWrite((HI_U32)(&(pOptmVdpReg->GP0_CSC_P1.u32)+OPTM_WBC_GP0_SEL*OPTM_GP_OFFSET), GP0_CSC_P1.u32);

        GP0_CSC_P2.u32 = OPTM_VDP_RegRead((HI_U32)(&(pOptmVdpReg->GP0_CSC_P2.u32)+OPTM_WBC_GP0_SEL*OPTM_GP_OFFSET));
        GP0_CSC_P2.bits.cscp11 = stCscCoef.csc_coef11;
        GP0_CSC_P2.bits.cscp12 = stCscCoef.csc_coef12;
        OPTM_VDP_RegWrite((HI_U32)(&(pOptmVdpReg->GP0_CSC_P2.u32)+OPTM_WBC_GP0_SEL*OPTM_GP_OFFSET), GP0_CSC_P2.u32);

        GP0_CSC_P3.u32 = OPTM_VDP_RegRead((HI_U32)(&(pOptmVdpReg->GP0_CSC_P3.u32)+OPTM_WBC_GP0_SEL*OPTM_GP_OFFSET));
        GP0_CSC_P3.bits.cscp20 = stCscCoef.csc_coef20;
        GP0_CSC_P3.bits.cscp21 = stCscCoef.csc_coef21;
        OPTM_VDP_RegWrite((HI_U32)(&(pOptmVdpReg->GP0_CSC_P3.u32)+OPTM_WBC_GP0_SEL*OPTM_GP_OFFSET), GP0_CSC_P3.u32);

        GP0_CSC_P4.u32 = OPTM_VDP_RegRead((HI_U32)(&(pOptmVdpReg->GP0_CSC_P4.u32)+OPTM_WBC_GP0_SEL*OPTM_GP_OFFSET));
        GP0_CSC_P4.bits.cscp22 = stCscCoef.csc_coef22;
        OPTM_VDP_RegWrite((HI_U32)(&(pOptmVdpReg->GP0_CSC_P4.u32)+OPTM_WBC_GP0_SEL*OPTM_GP_OFFSET), GP0_CSC_P4.u32);
    }    
