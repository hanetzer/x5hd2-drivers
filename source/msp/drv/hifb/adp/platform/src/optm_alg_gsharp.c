...
HI_VOID OPTM_ALG_GDtiInit(OPTM_ALG_GDTI_DRV_PARA_S *pstDtiDrvPara, OPTM_ALG_GDTI_RTL_PARA_S *pstDtiRtlPara)
{
	...
	pstDtiRtlPara->s8LTIHPTmp[0] = -21;//coeff[0]
	pstDtiRtlPara->s8LTIHPTmp[1] = -21;//coeff[1]
	pstDtiRtlPara->s8LTIHPTmp[2] = -11;//coeff[2]

	pstDtiRtlPara->u16LTIHFreqThrsh[0] = 60;//127;/*if 10bit ,the value is 511*/
	pstDtiRtlPara->u16LTIHFreqThrsh[1] = 61;//127;/*if 10bit ,the value is 511*/
	pstDtiRtlPara->u8LTICompsatMuti[0] = 128;/*if 10bit ,the value is 511*/
	pstDtiRtlPara->u8LTICompsatMuti[1] = 128;
	pstDtiRtlPara->u8LTICompsatMuti[2] = 128;
	...
	pstDtiRtlPara->s8CTIHPTmp[0] = -21;//coeff[0]
	pstDtiRtlPara->s8CTIHPTmp[1] = -21;//coeff[1]
	pstDtiRtlPara->s8CTIHPTmp[2] = -11;//coeff[2]
