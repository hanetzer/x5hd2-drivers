...
/* RETURN:      TM_OK if no error                                             */
/*                                                                            */
/* NOTES:       FreCut_sel=1 => FreqCut[6:0]=FreCut_r閑l - 128                */
...
/* RETURN:      TM_OK if no error                                             */
/*                                                                            */
/* NOTES:       0 : LF_freq[3:0] from I睠 is not shifted by RC cal results    */
/*              1 : LF_freq[3:0] from I睠 is shifted by RC cal results        */
/*============================================================================*/
tmErrorCode_t
