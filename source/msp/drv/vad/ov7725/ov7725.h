...
#define HI_FATAL_OV7725(fmt...) HI_FATAL_PRINT(HI_ID_OV7725, fmt)
#define HI_ERR_OV7725(fmt...) HI_ERR_PRINT(HI_ID_OV7725, fmt)
#define HI_WARN_OV7725(fmt...) HI_WARN_PRINT(HI_ID_OV7725, fmt)
#define HI_INFO_OV7725(fmt...) HI_INFO_PRINT(HI_ID_OV7725, fmt)
#define HI_DBG_OV7725(fmt...) HI_DBG_PRINT(HI_ID_OV7725, fmt)

#define OV7725_NAME "HI_OV7725"
...
#define DC_SET_SHARPNESS 0x06    /* sharpness£¬value_range£º0~255 */
...
#define    DC_VAL_AUTO 0x04    /*scene£¬auto*/
